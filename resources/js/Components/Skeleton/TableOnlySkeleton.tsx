        ...
        <div className="overflow-hidden border border-gray-200 rounded-lg">
            ...
            <div className="grid grid-cols-12 gap-4 px-4 py-3 text-xs text-gray-600 bg-gray-50">
                <div className="col-span-4">
                    <Skeleton className="w-24 h-3" /> {/* Transaction */}
                </div>
                <div className="hidden col-span-2 sm:block">
                    <Skeleton className="w-16 h-3" /> {/* Amount */}
                </div>
                <div className="hidden col-span-3 md:block">
                    <Skeleton className="h-3 w-14" /> {/* Date */}
                </div>
                <div className="hidden col-span-2 xl:block">
                    <Skeleton className="w-16 h-3" /> {/* Status */}
                </div>
                <div className="col-span-1">
                    <Skeleton className="w-16 h-3" /> {/* Account */}
                </div>
            </div>
            ...
            <div className="divide-y divide-gray-200">
                {Array.from({ length: 8 }).map((_, idx) => (
                    <div
                        key={idx}
                        className="grid grid-cols-12 gap-4 px-1 py-4 md:px-4"
                    >
                        {/* Transaction cell (avatar + name) */}
